...
CREATE OR REPLACE PROCEDURE SP_INSERTAR_FACTURA (IN_ID_VENDEDOR IN NUMBER, IN_ID_CLIENTE IN NUMBER, IN_TIPO_VENTA_ID IN NUMBER, IN_TOTAL_ENTREGA IN NUMBER, IN_MEDIO_PAGO_ID IN NUMBER) AS
...
INSERT INTO TAB_DETALLES_FACTURA (ID_FACTURA, PRODUCTO_ID, CANTIDAD, PRECIO, TOTAL_SIN_IVA, IVA, SUBTOTAL) 
VALUES (V_MAX_FACTURA, IN_PRODUCTO_ID, IN_CANTIDAD, V_PRECIO_PRODUCTO, V_TOTAL_SIN_IVA, IN_IVA, V_SUBTOTAL);
