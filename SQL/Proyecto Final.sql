...
DBMS_OUTPUT.put_line('Ejecucion ' || IN_ID_PRODUCTO ||  IN_CANTIDAD);
END;
/
...
CREATE OR REPLACE PROCEDURE SP_REVISION_INSERTAR_DETALLES_FACTURA(IN_OBJ_DETALLES_FACTURA IN OBJ_DETALLES_FACTURA, OUT_PRODUCTO_PROBLEMA OUT VARCHAR, RESULTADO OUT NUMBER) AS 
