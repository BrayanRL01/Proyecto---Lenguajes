...
SELECT ID_PRODUCTO, P.NOMBRE, CODIGO, C.NOMBRE AS CATEGORIA, DETALLE, PRECIO, TAMANO, CANTIDAD
...
CREATE OR REPLACE PROCEDURE SP_OBTENER_UN_TIPO_PERSONA(IN_ID_TIPO_PERSONA IN NUMBER, TIPO_PERSONAS OUT SYS_REFCURSOR) AS 
BEGIN
OPEN TIPO_PERSONAS FOR 
SELECT *
...
INSERT INTO TAB_DETALLES_FACTURA (ID_FACTURA, ID_DETALLE, PRODUCTO, CANTIDAD, TAMANO, PRECIO, TOTAL_SIN_IVA, IVA, SUBTOTAL) 
VALUES (V_MAX_FACTURA, OUT_MAX_DETALLE, V_PRODUCTO, IN_CANTIDAD, V_TAMANO, V_PRECIO_PRODUCTO, V_TOTAL_SIN_IVA, IN_IVA, V_SUBTOTAL);
END; 
/
...
CREATE OR REPLACE PROCEDURE SP_MODIFICAR_UN_TIPO_VENTA (IN_ID_TIPO_VENTA IN NUMBER, IN_NOMBRE IN VARCHAR2, RESULTADO OUT NUMBER) AS
BEGIN
...
CREATE OR REPLACE PROCEDURE SP_ELIMINAR_UN_TIPO_VENTA (IN_ID_TIPO_VENTA IN NUMBER , RESULTADO OUT NUMBER,  MENSAJE OUT VARCHAR2) AS 
BEGIN
...
CREATE OR REPLACE PROCEDURE SP_MODIFICAR_UN_MEDIO_DE_PAGO (IN_ID_MEDIO_PAGO IN NUMBER, IN_NOMBRE IN VARCHAR2, RESULTADO OUT NUMBER) AS
BEGIN
...
CREATE OR REPLACE PROCEDURE SP_ELIMINAR_UN_MEDIO_DE_PAGO (IN_ID_MEDIO_PAGO IN NUMBER, RESULTADO OUT NUMBER,  MENSAJE OUT VARCHAR2) AS 
BEGIN
...
CREATE OR REPLACE PROCEDURE SP_INSERTAR_PERSONA (IN_CEDULA IN NUMBER, IN_NOMBRE IN VARCHAR2, IN_PRIMER_APELLIDO IN VARCHAR2, IN_SEGUNDO_APELLIDO IN VARCHAR2, IN_DIRECCION IN VARCHAR2, IN_EMAIL VARCHAR2, IN_TELEFONO IN VARCHAR2, IN_TIPO_PERSONA_ID IN NUMBER) AS
BEGIN
...
CREATE OR REPLACE PROCEDURE SP_MODIFICAR_PERSONA (IN_ID_PERSONA IN NUMBER, IN_CEDULA IN NUMBER, IN_NOMBRE IN VARCHAR2, IN_PRIMER_APELLIDO IN VARCHAR2, IN_SEGUNDO_APELLIDO IN VARCHAR2, IN_DIRECCION IN VARCHAR2, IN_EMAIL VARCHAR2, IN_TELEFONO IN VARCHAR2, IN_TIPO_PERSONA_ID IN NUMBER, RESULTADO OUT NUMBER) AS
BEGIN
UPDATE TAB_PERSONAS 
SET 
CEDULA= IN_CEDULA,
...
CREATE OR REPLACE PROCEDURE SP_OBTENER_UNA_PERSONA (IN_ID_PERSONA IN NUMBER, PERSONAS OUT SYS_REFCURSOR) AS 
BEGIN
OPEN PERSONAS FOR 
SELECT *
FROM NEGOCIO.VW_PERSONAS
...
CREATE OR REPLACE PROCEDURE SP_OBTENER_PERSONAS_DE_UN_TIPO (V_TIPO_PERSONA IN VARCHAR2, PERSONAS OUT SYS_REFCURSOR)
AS
BEGIN
OPEN PERSONAS FOR 
SELECT *
FROM VW_PERSONAS PER
WHERE PER.TIPO_PERSONA = V_TIPO_PERSONA;
END;
/
*/

--Este procedimiento inserta un tipo de persona
CREATE OR REPLACE PROCEDURE SP_INSERTAR_TIPO_PERSONA (IN_NOMBRE IN VARCHAR2, RESULTADO OUT NUMBER) AS
BEGIN
...
CREATE OR REPLACE PROCEDURE SP_MODIFICAR_TIPO_PERSONA (IN_ID_TIPO_PERSONA IN NUMBER, IN_NOMBRE IN VARCHAR2, RESULTADO OUT NUMBER) AS
BEGIN
...
--Este procedimiento modifica a un tipo de persona en especifico
CREATE OR REPLACE PROCEDURE SP_MODIFICAR_ESTADO_USUARIO (IN_ID_ESTADO_USUARIO IN NUMBER, IN_NOMBRE IN VARCHAR2, RESULTADO OUT NUMBER) AS
BEGIN
...
CREATE OR REPLACE PROCEDURE SP_OBTENER_PRODUCTOS(IN_ID_PRODUCTO IN NUMBER , OUT_ID_PRODUCTO OUT VARCHAR2, OUT_CODIGO OUT VARCHAR2,OUT_NOMBRE OUT VARCHAR2, OUT_CATEGORIA OUT VARCHAR2, OUT_DETALLE OUT VARCHAR2, OUT_PRECIO OUT DECIMAL, OUT_TAMANO OUT VARCHAR2, OUT_CANTIDAD OUT NUMBER, RESULTADO OUT NUMBER) AS 
BEGIN
...
OUT_DETALLE OUT VARCHAR2, OUT_PRECIO OUT DECIMAL, OUT_TAMANO OUT VARCHAR2, OUT_CANTIDAD OUT NUMBER,RESULTADO OUT NUMBER) AS 
BEGIN
SELECT * INTO OUT_ID_PRODUCTO,
OUT_CODIGO,
OUT_NOMBRE,
...
CREATE OR REPLACE PROCEDURE SP_INSERTAR_PRODUCTO (IN_CODIGO IN VARCHAR2, IN_CATEGORIA_ID IN NUMBER, IN_MARCA_ID IN NUMBER, IN_NOMBRE IN VARCHAR2, IN_DETALLE IN VARCHAR2, IN_PRECIO IN DECIMAL, IN_TAMANO IN NUMBER, IN_CANTIDAD IN NUMBER, RESULTADO OUT NUMBER) AS
BEGIN
INSERT INTO TAB_PRODUCTOS (CODIGO, CATEGORIA_ID, MARCA_ID, NOMBRE, DETALLE, PRECIO, TAMANO,CANTIDAD) 
VALUES (IN_CODIGO, IN_CATEGORIA_ID, IN_MARCA_ID, IN_NOMBRE, IN_DETALLE, IN_PRECIO, IN_TAMANO,IN_CANTIDAD);
RESULTADO :=0;
END;
/
...
CREATE OR REPLACE PROCEDURE SP_OBTENER_MARCAS (TIPOS OUT SYS_REFCURSOR)
AS
BEGIN
OPEN TIPOS FOR 
...
CREATE OR REPLACE PROCEDURE SP_INSERTAR_MARCAS (IN_NOMBRE IN VARCHAR2, RESULTADO OUT NUMBER) AS
BEGIN
...
--Este procedimiento modifica a un tipo de persona en especifico
CREATE OR REPLACE PROCEDURE SP_MODIFICAR_MARCA (IN_ID_MARCA IN NUMBER, IN_NOMBRE IN VARCHAR2, RESULTADO OUT NUMBER) AS
BEGIN
UPDATE TAB_MARCAS 
SET 
NOMBRE=IN_NOMBRE
...
----Devolver un tipo de persona en base a su ID
CREATE OR REPLACE PROCEDURE SP_OBTENER_MARCA_ID (ID_M IN NUMBER,  RESULTADO OUT VARCHAR2)
AS
BEGIN
SELECT NOMBRE INTO RESULTADO FROM TAB_MARCAS WHERE ID_MARCA = ID_M;
END;
/

CREATE OR REPLACE PROCEDURE SP_ELIMINAR_MARCAS (IN_ID_MARCA IN NUMBER , RESULTADO OUT NUMBER) AS 
BEGIN
