...
COMMENT ON COLUMN NEGOCIO.TAB_ROLES.ID_ROLES IS 'Llave primaria de los roles.';
...
COMMENT ON COLUMN NEGOCIO.TAB_ESTADOS_USUARIO.ID_TIPO_PERSONA IS 'Llave primaria de los estados de usuario.';
...
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.CEDULA IS 'Número de cédula de la persona.';
...
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.DIRECCION IS 'Dirección de la persona.';
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.PRIMER_APELLIDO IS 'Email de la persona.';
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.SEGUNDO_APELLIDO IS 'Teléfono de la persona.';
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.TIPO_PERSONA_ID IS 'Llave foránea de la tabla Tipo Persona.';
...
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.NOMBRE_USUARIO IS 'Pronombre o nickname del usuario.';
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.NOMBRE IS 'Nombre del usuario.';
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.PRIMER_APELLIDO IS 'Primer apellido del usuario.';
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.SEGUNDO_APELLIDO  IS 'Segundo apellido del usuario.';
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.EMAIL IS 'Email del usuario.';
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.CONTRASENA IS 'Contraseña del usuario.';
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.ROLE_ID IS 'Llave foránea de la tabla Roles.';
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.ESTADO_ID  IS 'Llave foránea de la tabla Estado Usuario.';
--
...
COMMENT ON COLUMN NEGOCIO.TAB_CATEGORIAS.ID_CATEGORIA IS 'Llave primaria de la categoría.';
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.NOMBRE IS 'Nombre de la categoría.';
COMMENT ON COLUMN NEGOCIO.TAB_PERSONAS.CATEGORIA_MADRE_ID  IS 'Llave primaria de la categoría en caso que se llegue a crear una subcategoría.';
...
COMMENT ON COLUMN NEGOCIO.TAB_PRODUCTOS.CODIGO IS 'Código del producto.';
COMMENT ON COLUMN NEGOCIO.TAB_PRODUCTOS.CATEGORIA_ID  IS 'Llave foránea de la tabla Categorías.';
COMMENT ON COLUMN NEGOCIO.TAB_PRODUCTOS.MARCA_ID IS 'Llave foránea de la tabla Marcas.';
COMMENT ON COLUMN NEGOCIO.TAB_PRODUCTOS.NOMBRE IS 'Nombre del producto.';
COMMENT ON COLUMN NEGOCIO.TAB_PRODUCTOS.DETALLE IS 'Detalles o más información del producto.';
COMMENT ON COLUMN NEGOCIO.TAB_PRODUCTOS.ID_PRECIO IS 'Precio del producto.';
...
COMMENT ON COLUMN NEGOCIO.TAB_PRODUCTOS.UNIDAD_CANTIDAD_ID IS 'Llave foránea de la tabla Unidad de Cantidad.';
...
INSERT INTO TAB_PRODUCTOS(CODIGO, CATEGORIA_ID , MARCA_ID, NOMBRE, DETALLE, PRECIO, TAMANO, UNIDAD_CANTIDAD_ID, CANTIDAD) VALUES ('79330563',7,4,'Camiseta tipo polo','Tela Piqu�',23900,'S',1,14);--9
INSERT INTO TAB_PRODUCTOS(CODIGO, CATEGORIA_ID , MARCA_ID, NOMBRE, DETALLE, PRECIO, TAMANO, UNIDAD_CANTIDAD_ID, CANTIDAD) VALUES ('79330563',7,4,'Camiseta tipo polo','Tela Piqu�',23900,'M',1,10);--10
INSERT INTO TAB_PRODUCTOS(CODIGO, CATEGORIA_ID , MARCA_ID, NOMBRE, DETALLE, PRECIO, TAMANO, UNIDAD_CANTIDAD_ID, CANTIDAD) VALUES ('79330563',7,4,'Camiseta tipo polo','Tela Piqu�',23900,'L',1,9);--11
INSERT INTO TAB_PRODUCTOS(CODIGO, CATEGORIA_ID , MARCA_ID, NOMBRE, DETALLE, PRECIO, TAMANO, UNIDAD_CANTIDAD_ID, CANTIDAD) VALUES ('79330563',7,4,'Camiseta tipo polo','Tela Piqu�',23900,'XL',1,7);--12
...
INSERT INTO TAB_PRODUCTOS(CODIGO, CATEGORIA_ID , MARCA_ID, NOMBRE, DETALLE, PRECIO, TAMANO, UNIDAD_CANTIDAD_ID, CANTIDAD) VALUES ('97987546',5,20,'Pantal�n Levis','Pantal�n Caf�', 30500,'31',1, 2);--18
INSERT INTO TAB_PRODUCTOS(CODIGO, CATEGORIA_ID , MARCA_ID, NOMBRE, DETALLE, PRECIO, TAMANO, UNIDAD_CANTIDAD_ID, CANTIDAD) VALUES ('97987547',5,20,'Pantal�n Levis','Pantal�n Negro', 30500,'29',1, 2);--19
INSERT INTO TAB_PRODUCTOS(CODIGO, CATEGORIA_ID , MARCA_ID, NOMBRE, DETALLE, PRECIO, TAMANO, UNIDAD_CANTIDAD_ID, CANTIDAD) VALUES ('97987546',5,20,'Pantal�n Levis','Pantal�n Azul', 30500,'31',1, 2);--20
...
INSERT INTO TAB_PRODUCTOS(CODIGO, CATEGORIA_ID , MARCA_ID, NOMBRE, DETALLE, PRECIO, TAMANO, UNIDAD_CANTIDAD_ID, CANTIDAD) VALUES ('77881318',20,25,'Don Julio','Tequila a�ejo ', 15000,'750',4, 2);--25
...
INSERT INTO TAB_PRODUCTOS(CODIGO, CATEGORIA_ID , MARCA_ID, NOMBRE, DETALLE, PRECIO, TAMANO, UNIDAD_CANTIDAD_ID, CANTIDAD) VALUES ('23116789',9,15,'Tommy Hilfiger','Pantal�n de vestir Hombre', 12000,'32',1, 3);--30
INSERT INTO TAB_PRODUCTOS(CODIGO, CATEGORIA_ID , MARCA_ID, NOMBRE, DETALLE, PRECIO, TAMANO, UNIDAD_CANTIDAD_ID, CANTIDAD) VALUES ('23116789',9,15,'Tommy Hilfiger','Pantal�n de vestir Hombre', 12000,'29',1, 3);--31
INSERT INTO TAB_PRODUCTOS(CODIGO, CATEGORIA_ID , MARCA_ID, NOMBRE, DETALLE, PRECIO, TAMANO, UNIDAD_CANTIDAD_ID, CANTIDAD) VALUES ('23116789',9,15,'Tommy Hilfiger','Pantal�n de vestir Hombre', 12000,'31',1, 3);--32
...
COMMENT ON COLUMN NEGOCIO.TAB_PRODUCTOS.VENDEDOR_ID IS 'Llave foránea de la tabla Usuarios.';
COMMENT ON COLUMN NEGOCIO.TAB_PRODUCTOS.CLIENTE_ID IS 'Llave foránea de la tabla Personas.';
COMMENT ON COLUMN NEGOCIO.TAB_PRODUCTOS.TIPO_VENTA_ID IS 'Llave foránea de la tabla Tipo de Venta.';
COMMENT ON COLUMN NEGOCIO.TAB_PRODUCTOS.TOTAL_ENTREGA IS 'Total a pagar en caso que se deba enviar el producto a otro sitio.';
COMMENT ON COLUMN NEGOCIO.TAB_PRODUCTOS.TOTAL IS 'Total a pagar por el o los productos escogidos.';
COMMENT ON COLUMN NEGOCIO.TAB_PRODUCTOS.MEDIO_PAGO_ID IS 'Llave foránea de la tabla Medio de pago.';
COMMENT ON COLUMN NEGOCIO.TAB_PRODUCTOS.FECHA_HORA_VENTA IS 'Fecha en que se realizó la compra.';
...
COMMENT ON COLUMN NEGOCIO.TAB_DETALLES_FACTURA.ID_FACTURA IS 'Llave foránea de la tabla factura.';
