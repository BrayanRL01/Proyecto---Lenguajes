...
CREATE OR REPLACE PROCEDURE SP_OBTENER_PRODUCTOS(PRODUCTO OUT SYS_REFCURSOR) AS 
...
AS
BEGIN
OPEN SUB_CATS FOR SELECT * FROM TAB_CATEGORIAS WHERE CATEGORIA_MADRE_ID IS NOT NULL;
RESULTADO:= 0;
END;
/
