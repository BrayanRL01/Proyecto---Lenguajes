...
CONSTRAINT PK_PERSONAS_CATEGORIAS FOREIGN KEY(ROLE_ID) REFERENCES TAB_ROLES,
...
CONSTRAINT PK_FACTURA_ESTADOS_FACTURAS FOREIGN KEY(ESTADO_ID) REFERENCES ESTADOS_FACTURA);
...
constraint pk_detalleS_facturas FOREIGN KEY(ID_FACTURA)REFERENCES FACTURAS,
constraint pk_detalleS_productos FOREIGN KEY(PRODUCTO_ID)REFERENCES PRODUCTOS);


INSERT INTO TAB_ROLES (NOMBRE) VALUES ('Administracion');
INSERT INTO TAB_ROLES (NOMBRE) VALUES ('Cliente');
INSERT INTO TAB_ROLES (NOMBRE) VALUES ('Proveedor');
...
INSERT INTO PERSONAS  (NOMBRE,PRIMER_APELLIDO,SEGUNDO_APELLIDO,DIRECCION,EMAIL,TELEFONO,CONTRASENA,ROLE_ID,ESTADO_ID) VALUES ('Shreya','Mcdonald','Strickland','Whitefield View','Shreya@gmail.com','86543422','Canbiame_123',1,1);
INSERT INTO PERSONAS  (NOMBRE,PRIMER_APELLIDO,SEGUNDO_APELLIDO,DIRECCION,EMAIL,TELEFONO,CONTRASENA,ROLE_ID,ESTADO_ID) VALUES ('Xaver','Berry','Mejia','Whitefield View','Xaver@gmail.com','86423531','Cambiame_123',2,1);
INSERT INTO PERSONAS  (NOMBRE,PRIMER_APELLIDO,SEGUNDO_APELLIDO,DIRECCION,EMAIL,TELEFONO,CONTRASENA,ROLE_ID,ESTADO_ID) VALUES ('Eduard','Fernandez','Palmer','Port Riddell','Eduard@gmail.com','832341','Cambiame_123',2,1);
INSERT INTO PERSONAS  (NOMBRE,PRIMER_APELLIDO,SEGUNDO_APELLIDO,DIRECCION,EMAIL,TELEFONO,CONTRASENA,ROLE_ID,ESTADO_ID) VALUES ('Dipti','Thompson','Alexander','Fell Heath','Dipti@gmail.com','83153431','Cambiame_123',2,1);
INSERT INTO PERSONAS  (NOMBRE,PRIMER_APELLIDO,SEGUNDO_APELLIDO,DIRECCION,EMAIL,TELEFONO,CONTRASENA,ROLE_ID,ESTADO_ID) VALUES ('Nuria','Davidson','Mann','Thirlwall Drive','Nuria@gmail.com','83234133','Cambiame_123',2,1);
INSERT INTO PERSONAS  (NOMBRE,PRIMER_APELLIDO,SEGUNDO_APELLIDO,DIRECCION,EMAIL,TELEFONO,CONTRASENA,ROLE_ID,ESTADO_ID) VALUES ('Ketut','Ramirez','Wise','Southburn Terrace','Ketut@gmail.com','64234131','Cambiame_123',2,1);
INSERT INTO PERSONAS  (NOMBRE,PRIMER_APELLIDO,SEGUNDO_APELLIDO,DIRECCION,EMAIL,TELEFONO,CONTRASENA,ROLE_ID,ESTADO_ID) VALUES ('Wolfgang','Stevenson','Thornton','Oakley Paddock','Wolfgang@gmail.com','83134133','Cambiame_123',2,1);
INSERT INTO PERSONAS  (NOMBRE,PRIMER_APELLIDO,SEGUNDO_APELLIDO,DIRECCION,EMAIL,TELEFONO,CONTRASENA,ROLE_ID,ESTADO_ID) VALUES ('Subrahmanya','Burns','Khan','Williamson Bank','Subrahmanya@gmail.com','64354212','Cambiame_123',2,1);
INSERT INTO PERSONAS  (NOMBRE,PRIMER_APELLIDO,SEGUNDO_APELLIDO,DIRECCION,EMAIL,TELEFONO,CONTRASENA,ROLE_ID,ESTADO_ID) VALUES ('Ptah','Robinson','Kaye','Holden Elms','Ptah@gmail.com','86434231','Cambiame_123',2,1);
INSERT INTO PERSONAS  (NOMBRE,PRIMER_APELLIDO,SEGUNDO_APELLIDO,DIRECCION,EMAIL,TELEFONO,CONTRASENA,ROLE_ID,ESTADO_ID) VALUES ('Barbara','Kirby','Rossi','Crispin Coppice','Barbara@gmail.com','75331243','Cambiame_123',2,1);

INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Ropa','');  --1
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Perfumes','');--2
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Licores',''); --3
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Camisas',1);
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Pantalonetas',1);
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Zapatos',1);
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Camisetas',1);
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Vino',1);
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Pantalonetas',1);
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Zapatos',1);
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Camisetas',1);
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Perfumes Hombre',2);
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Perfumes Mujer',2);
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Whisky',3);
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Tipo licor 2',3);
INSERT INTO CATEGORIAS  (NOMBRE,CATEGORIA_MADRE_ID) VALUES ('Tipo licor 3',3);
...
SELECT ID_FACTURA, ID_DETALLE, PRECIO, CANTIDAD FROM DETALLES DET
LEFT JOIN PRODUCTOS PROD ON DET.PRODUCTO_ID = PROD.ID_PRODUCTO;
